...
import "../pages/DigitalMarketing.css";
import AOS from "aos";
...
import digitalImage from "../pages/Images/man-suit-standing-office-with-clipboard-pointing-poster-with-words 1.png";
import imglogo from "../pages/Images/19198948 1.png"
import imgLeft from "../pages/Images/Frame 1116607657 (1).png"
import iconImg from "../pages/Images/righticon.png"
import optionImg1 from "../pages/Images/SEO.png"
import optionImg2 from "../pages/Images/ppc.png"
import optionImg3 from "../pages/Images/social media.png"
import optionImg4 from "../pages/Images/content.png"
import optionImg5 from "../pages/Images/email marketing.png"
import optionImg6 from "../pages/Images/analytics.png"
import { Navigation } from 'swiper/modules';
import Footer from "../../Footer/footer"

import AgarisImg from "../pages/Images/4950546 1.png"
...
import service1 from "../pages/Images/image 19.png"
import service2 from "../pages/Images/image 20.png"
import service3 from "../pages/Images/image 21.png"
import service4 from "../pages/Images/image 22.png"
import service5 from "../pages/Images/image 23.png"
import service6 from "../pages/Images/image 24.png"
...
function DigitalMarketing() {
    ...
    const featuresData = [
        ...
        },
        {
            ...
            description:
                "Grow your brand with targeted content and engagement.",
        },
        {
            image: service3,
            title: "Ad Campaigns",
            description:
                "Data-driven ads that maximize ROI and reach.",
        },
        {
            image: service4,
            title: "Email & SMS Marketing",
            description:
                "Direct, personalized communication that converts.",
        },
        {
            image: service5,
        ...
        },
        {
            ...
            description:
                "Turn visitors into customers through smart tweaks.",
        },
    ];
    const swiperOptions = [
        {
            ...
            description:
                "Improve rankings and organic visibility on Google.",
            icon: optionImg1,
        },
        {
            title: "PPC Advertising",
            description: "Run paid ads for fast, targeted traffic and leads.",
            icon: optionImg2,
        },
        {
            title: "Social Media Marketing",
            description: "Grow your brand on platforms like Instagram and LinkedIn.",
            icon: optionImg3,
        },
        {
            title: "Content Marketing",
            description:
                "Engaging blogs, videos, and content to attract customers.",
            icon: optionImg4,
        },
        {
            title: "Email Marketing",
            description: "Automated campaigns to nurture leads and drive conversions.",
            icon: optionImg5,
        },
        {
            title: "Analytics & Optimization",
            description: " Data-driven insights for better ROI and performance.",
            icon: optionImg6,
        }
    ...
    const faqs = [
        {
            ...
            answer:
                "We offer SEO, Google Ads, social media marketing, email campaigns, content marketing, and conversion optimization.",
        },
        {
            question: " How does digital marketing benefit my business?",
            answer:
                "It boosts your online visibility, attracts targeted traffic, generates leads, and increases customer engagement and sales.",
        },
        {
            question: "  How long does it take to see results?",
            answer:
                " SEO results usually take 3–6 months, while paid ads like Google or Facebook can deliver leads almost immediately.",
        },
        {
            question: "  What is the difference between SEO and paid ads?",
            answer:
                "SEO builds long-term organic traffic, while paid ads offer instant visibility and faster lead generation through sponsored placements.",
        },
        {
            question: " Can I track the performance of my campaigns?",
            answer:
                "Yes, we provide detailed reports and dashboards with key metrics like traffic, engagement, conversions, and ROI.",
        },
    ];
    ...
    return (
        <div className="overflow-hidden">
            <div className="position-relative w-100">
                ...
                {/* Heading */}
                <h2 className="hero-heading" data-aos="fade-right">Digital Marketing</h2>

                {/* Breadcrumb */}
                <div className="hero-breadcrumb fs-8 fs-lg-3 p-2" data-aos="fade-right">Services /Digital Marketing</div>
            </div>
            ...
            <div className="container">
                <div className="d-flex justify-content-center align-items-center  coustum-app fw-medium  row pt-4">
                    <h2 className="responsive-title" data-aos="fade-down">
                        <span className="highlight">Results-Driven</span>  Digital Marketing Services
                    </h2>
                    <div className="col-lg-6 col-md-12 fs-6 fs-lg-1  text-start coustum-tite  fw-normal mb-4" data-aos="fade-right">
                        <p>
                            Agariss helps brands grow online with smart, ROI-driven strategies. We reach your audience where it matters most. From content to conversions, we boost your visibility, engagement, and sales.
                        </p>
                ...
                <div data-aos="fade-down">
                    <h2 className="offer-heading fs-6 responsive-heading fw-semibold text-center">Services We Offer</h2>
                    <p className="offer-description  fs-6 fs-lg-1 text-center fw-normal  mb-4">
                        ...
                        <div className="row g-4 d-flex justify-content-center align-items-center">
                            ...
                            <div className="col-12 col-lg-4 web-text" data-aos="fade-right">
                                <div className="d-flex flex-column gap-3">
                                    {[
                                        { title: "Growth Focus", desc: "We prioritize long-term success." },
                                        { title: "Clear Reporting", desc: "Honest, easy-to-understand reports." },
                                        { title: "Ongoing Optimization", desc: "Ongoing Optimization" },
                                        { title: "Data-Driven", desc: "Insights-based marketing strategies" },
                                    ].map((item, i) => (
                            ...
                            <div className="col-12 col-lg-4 web-text" data-aos="fade-left">
                                ...
                                <div className="d-flex flex-column gap-3">
                                    {[
                                        { title: "Custom Campaigns", desc: "Tailored to your brand needs." },
                                        { title: "Targeted Reach", desc: "Connect with the right audience." },
                                        { title: "ROI-Driven", desc: "Focused on maximizing your ROI." },
                                        { title: "Continuous Support", desc: "Ongoing assistance throughout your campaign." },
                                    ].map((item, i) => (
                                        <div className="p-lg-3 d-flex align-items-start fs-6 gap-3" key={i}>
                                            <img src={iconImg} alt="Icon" style={{ width: "40px", height: "40px" }} />
                                            <div>
